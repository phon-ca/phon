...
public class AssessmentWizardAction extends HookableAction {
	
	private static final Logger LOGGER = Logger
			.getLogger(AssessmentWizardAction.class.getName());
	...
	public AssessmentWizardAction(CommonModuleFrame projectFrame, QueryScript queryScript, PhonScript reportScript) {
		super();
	...
	public AssessmentWizardAction(CommonModuleFrame projectFrame, String queryScript, String reportScript) {
		super();
		this.projectFrame = projectFrame;
