...
import ca.phon.app.session.editor.view.transcript.actions.ToggleAlignmentVisibleViewAction;
import ca.phon.app.session.editor.view.transcript.actions.ToggleHeadersVisibleViewAction;
import ca.phon.app.session.editor.view.transcript.actions.ToggleSyllabificationVisibleViewAction;
import ca.phon.app.session.editor.view.transcript.actions.ToggleValidationModeViewAction;
...
import ca.phon.app.session.editor.view.transcript.extensions.HeaderTierExtension;
...
//        menuBuilder.addItem(".", toggleAlignmentComponentItem);
    ...
    private void setupRecordMenu(MenuBuilder menuBuilder) {
        ...
        toggleSingleRecordModeAct.putValue(PhonUIAction.NAME,
                isSingleRecordView() ? "Show full transcript" : "Show one record at a time");
