...
/**
 * Settings panel for importing an interval tier to word intervals.
 */
public class IntervalTierToWordIntervalsSettingsPanel extends JPanel {
    ...
    public IntervalTierToWordIntervalsSettingsPanel(Session session, IntervalTierToWordIntervalsSettings settings) {
        super();
    ...
    public IntervalTierToWordIntervalsSettings getSettings() {
        ...
        return new IntervalTierToWordIntervalsSettings(
            intervalTierName,
