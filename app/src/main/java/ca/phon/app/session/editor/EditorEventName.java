...
public enum EditorEventName {
	...
	EDITOR_LAYOUT_CHANGED("_EDITOR_LAYOUT_CHANGED_"),
	EDITOR_FINISHED_LOADING(MODIFICATION_EVENT + "_EDITOR_FINSIHED_LOADING_"),
...
//	RECORD_SEGMENT_CHANGED_EVT("_RECORD_SEGMENT_CHANGED_"),
	...
	/**
	 * IntervalTiers events
	 */
	TIMELINE_TIER_ADDED_EVT(MODIFICATION_EVENT + "TIMELINE_TIER_ADDED_"),
	TIMELINE_TIER_REMOVED_EVT(MODIFICATION_EVENT + "TIMELINE_TIER_REMOVED_"),
	TIMELINE_TIER_ADD_INTERVAL(MODIFICATION_EVENT + "TIMELINE_TIER_ADD_INTERVAL_"),
    TIMELINE_TIER_REMOVE_INTERVAL(MODIFICATION_EVENT + "TIMELINE_TIER_REMOVE_INTERVAL_"),
	TIMELINE_TIER_ADD_INTERVALS(MODIFICATION_EVENT + "TIMELINE_TIER_ADD_INTERVALS_"),
	TIMELINE_TIER_REMOVE_INTERVALS(MODIFICATION_EVENT + "TIMELINE_TIER_REMOVE_INTERVALS_"),
