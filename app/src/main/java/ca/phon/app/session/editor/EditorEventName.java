...
public enum EditorEventName {
	...
	ELEMENT_ADDED_EVT(MODIFICATION_EVENT + "ELEMENT_ADDED_"),
	ELEMENT_DELETED_EVT(MODIFICATION_EVENT + "ELEMENT_DELETED_"),
	ELEMENT_MOVED_EVT(MODIFICATION_EVENT + "ELEMENT_MOVED_EVT_"),
	COMMENT_ADDED_EVT(MODIFICATION_EVENT + "COMMENT_ADDED_"),
	COMMENT_DELETED_EVT(MODIFICATION_EVENT + "COMMENTED_DELETED_"),
	COMMENT_MOVED_EVT(MODIFICATION_EVENT + "COMMENT_MOVED_"),
	COMMENT_TYPE_CHANGED_EVT(MODIFICATION_EVENT + "COMMENT_TYPE_CHANGED_"),
	COMMENT_CHANGED_EVT(MODIFICATION_EVENT + "COMMENT_CHANGED_"),
	GEM_ADDED_EVT(MODIFICATION_EVENT + "GEM_ADDED_"),
	GEM_DELETED_EVT(MODIFICATION_EVENT + "GEM_DELETED_"),
	GEM_MOVED_EVT(MODIFICATION_EVENT + "GEM_MOVED_"),
	GEM_CHANGED_EVT(MODIFICATION_EVENT + "GEM_CHANGED_"),
	GEM_TYPE_CHANGED_EVT(MODIFICATION_EVENT + "GEM_TYPE_CHANGED_"),
	...
	SESSION_METADATA_CHANGED_EVT(MODIFICATION_EVENT + "_SESSION_METADATA_CHANGED_"),
