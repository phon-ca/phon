...
public class MiniConnectionPoolManager {
	 ...
	 * <code>maxConnections</code> connections are already in use, the method waits
	 * until a connection becomes available or <code>timeout</code> seconds elapsed.
	 * When the application is finished using the connection, it must close it in
	 * order to return it to the pool.
	 * 
