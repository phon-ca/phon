...
public class SearchHistoryEntryTest {
    ...
    public void testBuilderWithRequiredFields() {
        ...
        assertEquals(testQueryText, entry.getQueryText());
        assertEquals(testQueryType, entry.getQueryType());
    ...
    public void testBuilderWithAllFields() {
        ...
        assertEquals(testParameters, entry.getParameters());
    }
    ...
    public void testToBuilder() {
        ...
        assertEquals(testDate, copy.getDate());
        assertEquals("modified query", copy.getQueryText());
        assertEquals(testQueryType, copy.getQueryType());
        assertTrue(copy.isCaseSensitive());
        assertEquals(testParameters, copy.getParameters());
    }
    ...
    public void testGetParametersImmutable() {
        ...
        Map<String, String> params = entry.getParameters();
