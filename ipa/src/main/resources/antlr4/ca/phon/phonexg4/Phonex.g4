...
/*
 * Phonex - a pattern matching language for IPA transcripts.
 ...
 * ipa.xml with src/main/resources/xml/xslt/ipa2lexer-phonex.xslt'
 * The resulting file is saved as
 * target/antlr4/imports/phonexipa.g4
 */
import phonexipa;
...
matcher
    :   base_matcher plugin_matcher* quantifier?                                            # BaseMatcher
...
compound_phone_matcher
    :   phone_matcher (UNDERSCORE | LIGATURE) phone_matcher
    ;
