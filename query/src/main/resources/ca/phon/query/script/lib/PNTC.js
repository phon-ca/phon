...
exports.PNTC = {
    ...
    calc_pntc: function (group) {
        ...
        for (var i = 0; i < syllAlignment.getAlignmentLength(); i++) {
            ...
            var alignedTargetSyll = alignedSylls.get(0);
            var alignedActualSyll = alignedSylls.get(1);
            ...
            if (targetSyll == null) {
                ...
                var alignedTargetScInfo = alignedTargetSyll.elementAt(0).syllableInfo();
                var alignedTargetToneNumber = alignedTargetScInfo.tone();

                var alignedActualScInfo = alignedActualSyll.elementAt(0).syllableInfo();
                var alignedActualToneNumber = alignedActualScInfo.tone();

                if (alignedTargetToneNumber === null && alignedActualToneNumber === null) {
                    wasCorrect = true;
            ...
            var expandedResult = {
                target: alignedTargetSyll,
                actual: alignedActualSyll,
