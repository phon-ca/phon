...
import ca.phon.syllabifier.basic.io.BooleanConnector;
import ca.phon.syllabifier.basic.io.BooleanOperator;
import ca.phon.syllabifier.basic.io.ConstraintType;
...
public class Constraint {
	...
	public boolean matchesPhone(IPAElement ele) {
		List<IPAElement> testList = new ArrayList<IPAElement>();
		testList.add(ele);
	...
	public boolean matchesEmptyList() {
		...
		for(Object obj:ct.getOperatorAndPhoneSequenceAndConnector()) {
