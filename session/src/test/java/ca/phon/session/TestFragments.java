                ...
                <u>
                  <w>hello
                    <mor type="mor">
                      ...
                      <gra type="gra" index="0" head="1" relation="FOO"></gra>
                    </mor>
                  </w>
                  <w>world
                    <mor type="mor">
                      ...
                      <gra type="gra" index="1" head="0" relation="BAR"></gra>
                    </mor>
                  </w>
                  <t type="p">
                    <mor type="mor">
                      <mt type="p"></mt>
                      <gra type="gra" index="3" head="0" relation="PUNCT"></gra>
                    </mor>
                  </t>
                </u>""";
                ...
                <u>
                  <w>hello
                    <mor type="trn">
                      ...
                      <gra type="grt" index="0" head="1" relation="FOO"></gra>
                    </mor>
                  </w>
                  <w>world
                    <mor type="trn">
                      ...
                      <gra type="grt" index="1" head="0" relation="BAR"></gra>
                    </mor>
                  </w>
                  <t type="p">
                    <mor type="trn">
                      <mt type="p"></mt>
                      <gra type="grt" index="3" head="0" relation="PUNCT"></gra>
                    </mor>
                  </t>
                </u>""";
                ...
                <u>
                  <w>you
                    <mor type="trn">
                      ...
                      <gra type="grt" index="1" head="2" relation="SUBJ"></gra>
                    </mor>
                  </w>
                  <w>gonna
                    <mor type="trn">
                      ...
                      <gra type="grt" index="2" head="0" relation="ROOT"></gra>
                      <mor-post>
                        <mw>
                          <pos>
                            <c>inf</c>
                        ...
                        <gra type="grt" index="3" head="4" relation="INF"></gra>
                      </mor-post>
                    </mor>
                  </w>
                  <w>put
                    <mor type="trn">
                      <mw>
                        ...
                        <stem>put</stem>
                        <mk type="sfxf">ZERO</mk>
                      </mw>
                      <gra type="grt" index="4" head="2" relation="XCOMP"></gra>
                    </mor>
                  </w>
                  <w>the
                    <mor type="trn">
                      ...
                      <gra type="grt" index="5" head="6" relation="DET"></gra>
                    </mor>
                  </w>
                  <w>choo
                    <wk type="cmp"></wk>choo's
                    <mor type="trn">
                      <mwc>
                        <pos>
                          <c>n</c>
                      ...
                      <gra type="grt" index="6" head="7" relation="SUBJ"></gra>
                      <mor-post>
                        <mw>
                          <pos>
                            <c>v</c>
                        ...
                        <gra type="grt" index="7" head="4" relation="OBJ"></gra>
                      </mor-post>
                    </mor>
                  </w>
                  <w>wheel
                    <mor type="trn">
                      ...
                      <gra type="grt" index="8" head="7" relation="PRED"></gra>
                    </mor>
                  </w>
                  <w>on
                    <mor type="trn">
                      ...
                      <gra type="grt" index="9" head="8" relation="JCT"></gra>
                    </mor>
                  </w>
                  <t type="q">
                    <mor type="trn">
                      <mt type="q"></mt>
                      <gra type="grt" index="10" head="2" relation="PUNCT"></gra>
                    </mor>
                  </t>
                </u>""";
