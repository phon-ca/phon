 ...
 *
 */
public abstract class AbstractUtteranceFilter implements UtteranceFilter {
	 ...
	 */
	public List<IUtterance> filterUtterances(List<IUtterance> utts) {
		List<IUtterance> retVal = new ArrayList<IUtterance>();
