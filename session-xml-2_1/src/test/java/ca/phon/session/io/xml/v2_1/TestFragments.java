...
public class TestFragments {
    ...
    public void testOrthographyIPA() throws IOException {
        final String expected = """
                <u>
                  ...
                  <pause symbolic-length="simple"><mod><pause symbolic-length="simple"/></mod><pho><pause symbolic-length="simple"/></pho></pause>
        ...
        final ca.phon.session.Record record = factory.createRecord();
    ...
    public void testOrthographyMor() throws IOException {
        final String expected = """
                <u>
                  <w>hello<mor type="mor"><mw><pos><c>v</c></pos><stem>hello</stem></mw><gra type="gra" index="0" head="1" relation="FOO"/></mor></w>
                  <w>world<mor type="mor"><mw><pos><c>n</c></pos><stem>world</stem></mw><gra type="gra" index="1" head="0" relation="BAR"/></mor></w>
                  <t type="p"><mor type="mor"><mt type="p"/><gra type="gra" index="3" head="0" relation="PUNCT"/></mor></t>
                </u>""";
    ...
    public void testOrthographyTrn() throws IOException {
        final String expected = """
                <u>
                  <w>hello<mor type="trn"><mw><pos><c>v</c></pos><stem>hello</stem></mw><gra type="grt" index="0" head="1" relation="FOO"/></mor></w>
                  <w>world<mor type="trn"><mw><pos><c>n</c></pos><stem>world</stem></mw><gra type="grt" index="1" head="0" relation="BAR"/></mor></w>
                  <t type="p"><mor type="trn"><mt type="p"/><gra type="grt" index="3" head="0" relation="PUNCT"/></mor></t>
                </u>""";
    ...
    public void testMorCompoundAndPostclitic() throws IOException {
        final String expected = """
                <u>
                  <w>you<mor type="trn"><mw><pos><c>pro</c></pos><stem>you</stem></mw><gra type="grt" index="1" head="2" relation="SUBJ"/></mor></w>
                  <w>gonna<mor type="trn"><mw><pos><c>part</c></pos><stem>go</stem><mk type="sfx">PROG</mk></mw><gra type="grt" index="2" head="0" relation="ROOT"/><mor-post><mw><pos><c>inf</c></pos><stem>to</stem></mw><gra type="grt" index="3" head="4" relation="INF"/></mor-post></mor></w>
                  <w>put<mor type="trn"><mw><pos><c>v</c></pos><stem>put</stem><mk type="sfxf">ZERO</mk></mw><gra type="grt" index="4" head="2" relation="XCOMP"/></mor></w>
                  <w>the<mor type="trn"><mw><pos><c>det</c></pos><stem>the</stem></mw><gra type="grt" index="5" head="6" relation="DET"/></mor></w>
                  <w>choo<wk type="cmp"/>choo's<mor type="trn"><mwc><pos><c>n</c></pos><mw><pos><c>on</c></pos><stem>choo</stem></mw><mw><pos><c>on</c></pos><stem>choo</stem></mw></mwc><gra type="grt" index="6" head="7" relation="SUBJ"/><mor-post><mw><pos><c>v</c><subc>cop</subc></pos><stem>be</stem><mk type="sfxf">3S</mk></mw><gra type="grt" index="7" head="4" relation="OBJ"/></mor-post></mor></w>
                  <w>wheel<mor type="trn"><mw><pos><c>n</c></pos><stem>wheel</stem></mw><gra type="grt" index="8" head="7" relation="PRED"/></mor></w>
                  <w>on<mor type="trn"><mw><pos><c>adv</c><subc>loc</subc></pos><stem>on</stem></mw><gra type="grt" index="9" head="8" relation="JCT"/></mor></w>
                  <t type="q"><mor type="trn"><mt type="q"/><gra type="grt" index="10" head="2" relation="PUNCT"/></mor></t>
                </u>""";
