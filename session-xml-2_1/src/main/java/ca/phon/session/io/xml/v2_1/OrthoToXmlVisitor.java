...
public class OrthoToXmlVisitor extends AbstractOrthographyVisitor {
	...
	private List<JAXBElement<XmlPhoneticTranscriptionType>> writePhoModData(OneToOne oneToOne) {
		...
		for(String tierName:oneToOne.getIpaTierData().keySet()) {
			...
			final XmlSessionWriterV2_1 writer = new XmlSessionWriterV2_1();
	...
	private void writeGraspTierData(XmlSessionWriterV2_1 writer, XmlMorType xmlMorType, GraspTierData grasp, String type) {
		int graIdx = 0;
