...
public final class XMLFragments {
    ...
    public static void writeFragment(JAXBElement<?> jaxbElement, OutputStream out, boolean includeNamespace, boolean formatted) throws IOException {
        try(BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(out))) {
            ...
            xmlStreamWriter = new EmptyTagXMLStreamWriter(new SessionXMLStreamWriter(xmlStreamWriter, formatted));
            if(!includeNamespace)
                xmlStreamWriter.setDefaultNamespace(XmlSessionWriterV2_1.DEFAULT_NAMESPACE);
            final JAXBContext context = JAXBContext.newInstance(ObjectFactory.class);
            final Marshaller marshaller = context.createMarshaller();
            marshaller.setProperty(Marshaller.JAXB_FRAGMENT, true);
            marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
            if(includeNamespace)
                marshaller.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, String.format("%s %s", XmlSessionWriterV2_1.DEFAULT_NAMESPACE, XmlSessionWriterV2_1.DEFAULT_NAMESPACE_LOCATION));
    ...
    public static String toXml(Orthography orthography, boolean includeNamespace, boolean formatted) throws IOException {
        XmlSessionWriterV2_1 writer = (XmlSessionWriterV2_1) (new SessionOutputFactory())
                .createWriter(XmlSessionWriterV2_1.class.getAnnotation(SessionIO.class));
        ...
        try(ByteArrayInputStream in = new ByteArrayInputStream(text.getBytes(StandardCharsets.UTF_8))) {
            ...
            XMLStreamWriter noXmlDeclWriter = new DelegatingXMLStreamWriter(writer) {
                ...
                public void writeStartElement(String localName) throws XMLStreamException {
                    ...
                    if(!wroteFirstStart) {
                        super.writeDefaultNamespace(XmlSessionWriterV2_1.DEFAULT_NAMESPACE);
                    }
    ...
    public static Orthography orthographyFromXml(String xml) throws IOException {
        ...
        XmlSessionReaderV2_1 xmlReader = (XmlSessionReaderV2_1) (new SessionInputFactory()).createReader(XmlSessionReaderV2_1.class.getAnnotation(SessionIO.class));
